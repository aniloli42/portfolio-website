	...
	return (
		<section
			...
			<div className='grid justify-items-center lg:[grid-template-rows:2em_minmax(3em,8em)_auto] lg:[grid-template-columns:max-content_auto] lg:justify-items-start lg:gap-x-8 lg:gap-y-6'>
				<h2 className='mb-8 text-3xl font-bold text-main dark:text-secondary/90 underline underline-offset-4 lg:mb-0 '>
					ABOUT ME
				</h2>
				...
				<p className='mt-4 max-w-xs text-center text-base text-main/80 dark:text-secondary/80 sm:max-w-md sm:text-xl lg:text-left'>
