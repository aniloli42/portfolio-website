...
const AboutMe = ({ resumeLink: CVLink }) => {
  const {
    node: { resumeLink },
  } = CVLink[0];
  ...
  return (
    <section
      ...
      id="about-me"
    >
      <div className="grid justify-items-center lg:[grid-template-rows:2em_5em_auto] lg:[grid-template-columns:max-content_auto] lg:justify-items-start lg:gap-x-8 lg:gap-y-6">
