const Journey = ({
	...
	return (
		<div className='relative mb-3 pl-6 shadow-sm after:absolute after:left-0 after:top-0 after:h-6 after:w-6 after:-translate-x-[58%] after:rounded-full after:border-4 after:border-main/50 dark:after:border-secondary/50  after:bg-secondary dark:after:bg-zinc-900 after:[content:""] md:pl-8'>
			<div className='custom-shadow relative rounded-md bg-secondary dark:bg-zinc-700 px-4 py-2 after:absolute after:top-0 after:left-0 after:h-0 after:w-0 after:-translate-x-full  after:translate-y-1/4 after:border-t-[8px] after:border-b-[8px] after:border-r-[10px] after:border-main/20 dark:after:border-l-zinc-500/40 dark:after:border-r-zinc-500/40 after:border-t-transparent after:border-b-transparent after:[content:""]'>
				<div>
