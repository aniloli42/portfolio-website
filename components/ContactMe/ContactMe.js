  ...
  return (
    <section id='contact-me' className='my-20 scroll-m-24 py-4'>
      ...
      <div className='my-4 flex flex-col items-center justify-center'>
        <form
          method='post'
          className='flex max-w-xs flex-1 flex-col gap-4 md:w-[500px]'
        ...
        >
          ...
          <button
            type='submit'
            className='rounded-sm bg-white py-2 px-4 text-gray-800 outline-none transition-colors duration-200 ease-in-out hover:bg-gray-300 hover:shadow-md hover:shadow-gray-500/20 focus-visible:bg-gray-300 focus-visible:shadow-md focus-visible:shadow-gray-500/20'
          >
            Send Message
          </button>
          {error && (
